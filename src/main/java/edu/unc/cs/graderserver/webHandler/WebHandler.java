package edu.unc.cs.graderServer.webHandler;
...
import edu.unc.cs.graderServer.webHandler.pages.AuthPage;
import edu.unc.cs.graderServer.webHandler.pages.GradingResultPage;
import edu.unc.cs.graderServer.webHandler.pages.IAuthPage;
import edu.unc.cs.graderServer.webHandler.pages.IGraderPage;
import edu.unc.cs.graderServer.webHandler.pages.IGradingResultPage;
import edu.unc.cs.graderServer.webHandler.pages.INotFoundPage;
import edu.unc.cs.graderServer.webHandler.pages.IStudentDataLookupPage;
import edu.unc.cs.graderServer.webHandler.pages.IStudentDataStatisticsPage;
import edu.unc.cs.graderServer.webHandler.pages.IUploadPage;
import edu.unc.cs.graderServer.webHandler.pages.NotFoundPage;
import edu.unc.cs.graderServer.webHandler.pages.StudentDataLookupPage;
import edu.unc.cs.graderServer.webHandler.pages.StudentDataStatisticsPage;
import edu.unc.cs.graderServer.webHandler.pages.UploadPage;
import edu.unc.cs.graderServer.webHandler.pages.css.AuthCSS;
import edu.unc.cs.graderServer.webHandler.pages.css.IAuthCSS;
import edu.unc.cs.graderServer.webHandler.pages.helpers.GraderPageSetup;
        ...
        if (requestLine.contains(" / ")) {
            ...
            try {
                ...
                if (requestObj.isMultipart()) {
                    ...
                    return buildHeader(303, html.length(), "Location: https://classroom.cs.unc.edu/~vitkus/grader/grading.php?id=" + uuid) + html;
                } else {
